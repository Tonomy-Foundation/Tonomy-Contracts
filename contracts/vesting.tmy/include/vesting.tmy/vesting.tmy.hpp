...
namespace vestingtoken
{
    ...
    static const std::map<int, vesting_category> vesting_categories = {
        ...
        {29, {days(0 * 30), days(42), days(6 * 30), 0.15}}, // Double Special Round - Full
        {30, {days(0 * 30), days(42), days(3 * 30), 0.3}}, // Double Special Round - Part 1
        {31, {days(0 * 30), days(42 + 3 * 30), days(3 * 30), 0.0}}, // Double Special Round - Part 2
        // Testing categories:
        #ifdef BUILD_TEST
