...
cleos set contract eosio /var/contracts/contracts/eosio.boot eosio.boot.wasm eosio.boot.abi -p eosio@active
sleep .1

./initialize-features.sh
sleep 1

cleos set contract eosio /var/contracts/contracts/eosio.bios eosio.bios.wasm eosio.bios.abi -p eosio@active
sleep 1